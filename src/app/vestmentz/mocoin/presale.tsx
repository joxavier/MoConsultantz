...
const PreSaleInstructions: React.FC = () => {
    return (
        <div className="text-center items-center p-10">
            ...
            <div className="mt-8">
                <h2 className="text-xl sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl mb-4">Step 1: Send Solana to movestmentz.sol</h2>
            ...
            <div className="mt-8 flex justify-center items-center flex-col">
                <h3 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl mb-4">Step 2: Follow MoVestmentz on Instagram</h3>
                <p className="text-m text-center">
